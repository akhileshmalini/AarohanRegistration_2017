...
public class Feedback_Statistics extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new StatisticFeedbackAdapter(arrayList,getApplicationContext(),Feedback_Statistics.this);
